                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {stockLocation.map((entry, index) => {
                                // Check if lines have changed compared to initialStock
                                const isChanged = initialStock[index] && entry.qty !== initialStock[index].qty;
                                    ...
                                    >
                                        ...
                                        <td className="text-center">
                                            <div className="inline-flex items-center gap-2 rounded-full border-2 border-(--ezoko-ink) bg-(--ezoko-paper) px-2 py-1">
                                                ...
                                                <span className={`min-w-[2ch] text-xs font-bold transition-all ${isChanged
                                                    ? "text-(--ezoko-mint) scale-125 underline"
                                                    : "text-(--ezoko-ink)"
                                                    }`}>
                                                    {entry.qty}
                                                </span>
